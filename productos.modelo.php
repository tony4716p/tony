...
class ModeloProductos{
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, id_subcategoria, empresa, tipo, ruta, estado, titulo, titular, descripcion, multimedia, detalles, precio, portada, oferta, precioOferta, descuentoOferta, imgOferta, finOferta, peso, entrega, disponibilidad, Proveedor, codigo) VALUES (:id_categoria, :id_subcategoria, :empresa, :tipo, :ruta, :estado, :titulo, :titular, :descripcion, :multimedia, :detalles, :precio, :portada, :oferta, :precioOferta, :descuentoOferta, :imgOferta, :finOferta,  :peso, :entrega, :disponibilidad, :Proveedor, :codigo)");
	...
	static public function mdlEditarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_categoria = :id_categoria, id_subcategoria = :id_subcategoria, empresa = :empresa, tipo = :tipo, ruta = :ruta, estado = :estado, titulo = :titulo, titular = :titular, descripcion = :descripcion, multimedia = :multimedia, detalles = :detalles, precio = :precio, portada = :portada, oferta = :oferta, precioOferta = :precioOferta, descuentoOferta = :descuentoOferta, imgOferta = :imgOferta, finOferta = :finOferta, peso = :peso, entrega = :entrega, disponibilidad = :disponibilidad, Proveedor = :Proveedor WHERE id = :id");
	...
	static public function mdlMostrarProdutosConAletaDeStock($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE disponibilidad > 11  AND disponibilidad <= 15  AND estado != 0");
